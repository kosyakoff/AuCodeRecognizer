    ...
    public partial class MainActivity
    {
        ...
        private void RecordVideoButton_Click(object sender, EventArgs e)
        {
            if (!isRecording)
            {
                ...
                _cameraDevice.CreateCaptureSession(new List<Surface> { _previewSurface, mediaRecorder.Surface }, _videoSessionStateCallback, _backgroundHandler);
            }
            else
            {
        ...
        {
            var recordRequestBuilder = _cameraDevice.CreateCaptureRequest(CameraTemplate.Preview);
            recordRequestBuilder.AddTarget(_previewSurface);
            ...
            _captureSession.SetRepeatingRequest(recordRequestBuilder.Build(), null, null);
